...
export class PlotterController {
  ...
  private funcColor: HTMLInputElement;
  ...
  // Generador de colores automáticos para las siguientes funciones
  private getNextColorCallback: () => string;
  ...
  constructor(
    ...
    funcColor: HTMLInputElement,
    btnZoomIn: HTMLButtonElement,
    btnZoomOut: HTMLButtonElement,
    btnReset: HTMLButtonElement,
    canvas: HTMLCanvasElement,
    getNextColorCallback: () => string
  ) {
    this.model = model;
   ...
   */
  private tryAddFunction(expression: string, color: string): boolean {
    try {
   ...
   */
  private handleMouseMoveCoords(e: MouseEvent) {
   ...
   */
  private handleWindowMouseMoveDrag(e: MouseEvent) {
