...
export interface ThemePalette {
  /** Color hexadecimal base para la mayoría de las barras. */
  base: string;
  /** Color hexadecimal de destaque para resaltar datos específicos. */
  accent: string;
}
 ...
 */
export function getPalette(name: string): ThemePalette {
