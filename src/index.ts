...
const form = document.getElementById('add-func-form') as HTMLFormElement;
const funcInput = document.getElementById('func-input') as HTMLInputElement;
const funcColor = document.getElementById('func-color') as HTMLInputElement;
const errorFeedback = document.getElementById('func-error') as HTMLDivElement;
const errorMessage = document.getElementById('error-message') as HTMLSpanElement;
const functionsListContainer = document.getElementById('functions-list') as HTMLDivElement;
...
const rangeXText = document.getElementById('range-x-text') as HTMLSpanElement;
const rangeYText = document.getElementById('range-y-text') as HTMLSpanElement;

// Elementos de coordenadas bajo el cursor
const coordX = document.getElementById('coord-x') as HTMLSpanElement;
const coordY = document.getElementById('coord-y') as HTMLSpanElement;
